...
class RequestInterface {
	private:
		...
		virtual void GETRequest(const Request &Req, const Config &Conf,
								Response &Res)  = 0;
		//		virtual void POSTRequest(const Request &Req, const Config &Conf, Response
		//&Res)   = 0; 		virtual void DELETERequest(const Request &Req, const Config &Conf,
		//Response &Res) = 0; 		virtual void OTHERRequest(const Request &Req, const Config
		//&Conf, Response &Res)  = 0;
